...
Zu sichern ist ein LVM2 mit einem recht kleinen `/root`, `/etc` und der Kram auf `/home`, der zum Glück noch überschaubar groß ist.
...
/dev/mapper/vg0-restic  250G   57G  194G  23% /restic
```
...
created restic repository 1c28ea9e7b at /root/keks
