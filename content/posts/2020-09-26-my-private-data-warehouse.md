...
Handling data at volume, and getting rid of data no longer needed, is much easier in MySQL [when using partitions]({{< relref "/2020-09-24-mysql-deleting-data.md" >}}).
