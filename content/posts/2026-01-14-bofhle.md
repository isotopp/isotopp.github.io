...
That is, you get to guess a 5 letter Unix command in 6 tries or less.
...
Well, the objective is to solve the game, so let's just use their list.
...
I am using this to eliminate things:
