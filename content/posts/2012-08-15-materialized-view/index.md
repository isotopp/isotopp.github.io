...
![Normalisierte Darstellung von Daten](normalized_view.png)
...
![Materialized View](materialized_view.png)
...
![Denormalisierungsmaschine](queue.png)
...
![Graph: SSD Lifetime](ssd_estimated_lifetime.png)
