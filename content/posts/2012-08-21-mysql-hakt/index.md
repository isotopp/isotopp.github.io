...
![MySQL: Replication Delay](mysql-problem1-replication-delay.png)
...
![System: Disk I/O Operations](mysql-problem2-disk-read-spike.png)
...
![MySQL: InnoDB Buffer Pool Usage](mysql-problem3-buffer-pool-drop.png)
