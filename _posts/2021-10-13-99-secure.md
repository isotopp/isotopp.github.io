...
Es gibt eben doch besser und schlechter konfigurierte Systeme.

Und es gibt sogar dokumentiere und allgemein anerkannte Best Practices, in englischer und deutscher Sprache. 
...
Der Grundschutz wie im "Bundesamt für Sicherheit in der Informationstechnik" (BSI) veröffentlicht hat viele Spezialhandbücher für besondere Anwendungszwecke.
...
Das ist Amtsdeutsch für "Wenn Du das nicht machst brauchst Du gar nicht weiter zu spielen".
...
Damit ist auch die 99%-Latte gerissen. Es geht mehr so darum, überhaupt die allerersten grundlegenden Basisanforderungen zu erfüllen, die man braucht, um überhaupt ernsthaft Security angehen zu können.
...
Wir können damit ausschließen, daß für dieses System und seine Betreiberorganisation ein Security Review stattgefunden hat, und es ist nicht ganz unwahrscheinlich, daß ein solcher Prozeß überhaupt existiert.
...
Anders gesagt: "Unsere Systeme sind so konfiguriert, daß nicht jeder spaßorientierte Mensch auf Mate an einem langsamen Samstagabend in Quarantäne damit Karussel fahren kann." schon einmal ein guter Anfang.
...
Ein Risiko Management Prozeß ist wie jeder Prozeß eine Schleife, bei denen man Angreifer und Angriffe identifiziert, Risiken bewerten, Maßnahmen gegen die Risiken definiert und umsetzt und dann wiederholt.
...
Wenn Du so eine HTCCV haben willst, dann wird der Versicherer in der Regel seinen Taschenrechner anwerfen und Dir einen Tarif machen, der auf der Einschätzung Deiner Sicherheit durch einen von ihm beauftragten Auditor basieren.
...
Als Inhaber einer HTCCV wird man also regelmäßig, meist jährlich oder im jährlichen Wechsel mit einer Datenschutz-Prüfung die Auditoren im Haus haben, und sie werden jedes Mal einen grundlegenden Überblick haben wollen und jedes Jahr ein anderes Thema zur besonderen Vertiefung auswählen.

Damit hat man auch den von mir oben geforderten Test mit Audit als Teil der Versicherungsauflagen.
Meiner persönlichen Erfahrung mit solchen Auditoren finden die solche verscharchten Setups wie das ganz oben in weniger als 15 Sekunden. 
...
Auch dem Laien ist intuitiv klar, dass das keine skalierbare Strategie ist.
