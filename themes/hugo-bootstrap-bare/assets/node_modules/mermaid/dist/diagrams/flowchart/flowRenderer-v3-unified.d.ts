...
export declare const draw: (text: string, id: string, _version: string, diag: any, positions?: Positions) => Promise<void>;
declare const _default: {
    getClasses: (text: string, diagramObj: any) => Map<string, DiagramStyleClassDef>;
    draw: (text: string, id: string, _version: string, diag: any, positions?: Positions) => Promise<void>;
};
