import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-MPM6TOF7.mjs";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-DKH7L6O3.mjs";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = /* @__PURE__ */ __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ __name(async () => await import("./dagre-WRLBMN4V.mjs"), "loader")
    },
    {
      name: "swimlane",
      loader: /* @__PURE__ */ __name(async () => await import("./swimlanes-TLWVG3JD.mjs"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: /* @__PURE__ */ __name(async () => await import("./cose-bilkent-UCWTYXWA.mjs"), "loader")
      }
    ] : []
  ]);
