...
import {
  getDiagramElement
} from "./chunk-HPLX5OYV.mjs";
import {
  setupViewPortForSVG
} from "./chunk-BYAF6FXG.mjs";
import {
  JSON_SCHEMA,
  load
} from "./chunk-PWCFYZI5.mjs";
import {
  getRegisteredLayoutAlgorithm,
  render
} from "./chunk-STSWKLMO.mjs";
import {
  createTooltip
} from "./chunk-ZICDAICJ.mjs";
import {
  isValidShape
...
You have to call mermaid.initialize.`
  ...
  addSubGraph(_id, list, _title) {
    ...
    const dir = rawDir ?? (flowchartConfig.inheritDir ? this.getDirection() ?? getConfig().direction ?? void 0 : void 0);
