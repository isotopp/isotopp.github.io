import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-TRQY2T3P.mjs";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-HQMLCRZ6.mjs";
import {
  interpolateToCurve
} from "./chunk-BSZA5ISF.mjs";
import {
  common_default,
  getConfig
...
var registerDefaultLayoutLoaders = /* @__PURE__ */ __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ __name(async () => await import("./dagre-ZXKKJJHT.mjs"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: /* @__PURE__ */ __name(async () => await import("./cose-bilkent-WZ3F43K2.mjs"), "loader")
      }
    ] : []
  ]);
