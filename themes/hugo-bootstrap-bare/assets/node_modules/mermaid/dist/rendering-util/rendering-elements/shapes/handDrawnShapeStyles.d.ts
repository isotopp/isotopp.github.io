...
export declare const isLabelStyle: (key: string) => key is "font-family" | "font-size" | "font-weight" | "text-align" | "white-space" | "line-height" | "font-style" | "color" | "text-decoration" | "text-transform" | "letter-spacing" | "word-spacing" | "text-shadow" | "text-overflow" | "word-wrap" | "word-break" | "overflow-wrap" | "hyphens";
